#include <lab_tutorials/goToGoal.h>
...
goToGoalAction::~goToGoalAction()
{
}
bool goToGoalAction::init()
{
...
void goToGoalAction::executeCB(const lab_tutorials::goToGoalGoalConstPtr &goal){
